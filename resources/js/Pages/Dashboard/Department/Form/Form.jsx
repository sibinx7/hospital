...
export default function DepartmentForm({ buttonName='Save', department={}, ...props}){
  const id = department.id;

  let apiUrl = '/dashboard/staff/department/store';
  if(id){
    apiUrl = `/dashboard/staff/department/${id}/update`
  }
      	...
      	<form onSubmit={submit } encType={`multipart/form-data`} action="" method={`post`}>
                  ...
                  <div className="flex flex-col w-full mb-5">
                    <div className="form-group mb-5">
                      ...
                      <input name={`name`} disabled={id && true} readOnly={id && true} value={data.name} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="department-name" type="text" placeholder="Department Name"
