				...
				<div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
					...
					<div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
						<ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
							<li>
								<a href="#" className="uppercase font-bold" aria-current="page">Home</a>
							</li>
							<li>
								<a href="#" className="uppercase font-bold">Company</a>
							</li>
							<li>
								<a href="#" className="uppercase font-bold">Marketplace</a>
							</li>
							<li>
								<a href="#" className="uppercase font-bold">Features</a>
							</li>
							<li>
								<a href="#" className="uppercase font-bold">Team</a>
							</li>
							<li>
								<a href="#" className="uppercase font-bold">Contact</a>
							</li>
						</ul>
					</div>
				</div>
